...
namespace ETechFlow\BannerSlider\Test\Unit\Model;
...
/**
 * Portal-only licensing tests for ETechFlow_BannerSlider.
 *
...
{
    private const PORTAL = 'https://license-service.etechflow.com';
    ...
    public function testPortalIssuedKeyValidatedByPortalIsValid(): void
    {
        ...
        $this->setConfig([
            ...
            LicenseValidator::XML_PATH_PORTAL_URL  => self::PORTAL,
        ]);
        $this->setCacheMiss();
    ...
    public function testExplicitRevokeFlagWinsOverEverything(): void
    {
        ...
        $this->setConfig([
            LicenseValidator::XML_PATH_LICENSE_KEY => 'SP-live-abc123',
            LicenseValidator::XML_PATH_PORTAL_URL  => self::PORTAL,
            'etechflow_bannerslider/license/revoked' => '1',
        ]);
        $this->setCacheMiss();
     ...
     * field the old client-side path used to trust), and they can keep the
    ...
    public function testForgedKeyAndAttackerControlledConfigCannotBypass(): void
    {
        ...
        $this->setConfig([
            ...
            // Every field the removed local-grace/HMAC path used to trust, forged.
            'etechflow_bannerslider/license/issued_key'  => 'SP-i-made-this-up',
            'etechflow_bannerslider/license/issued_at'   => (string) time(),
            'etechflow_bannerslider/license/ip_blocked'  => '0',
        ]);
    ...
    {
        $this->setHost('shop.example.com');
        $this->setConfig([LicenseValidator::XML_PATH_PORTAL_URL => self::PORTAL]);
        $this->setCacheMiss();
